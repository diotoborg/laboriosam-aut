<div align="center">
  ...
  <h1>@diotoborg/laboriosam-aut</h1>
  <p>ESLint plugin for Jest</p>
</div>

[![Actions Status](https://github.com/diotoborg/laboriosam-aut/actions/workflows/nodejs.yml/badge.svg?branch=main)](https://github.com/diotoborg/laboriosam-aut/actions)

## Installation

```bash
yarn add --dev eslint @diotoborg/laboriosam-aut
```

**Note:** If you installed ESLint globally then you must also install
`@diotoborg/laboriosam-aut` globally.
...
```js
const jest = require('@diotoborg/laboriosam-aut');
...
💼
[Configurations](https://github.com/diotoborg/laboriosam-aut/blob/main/README.md#shareable-configurations)
enabled in.\
⚠️ [Configurations](https://github.com/diotoborg/laboriosam-aut/blob/main/README.md#shareable-configurations)
set to warn in.\
✅ Set in the `recommended`
[configuration](https://github.com/diotoborg/laboriosam-aut/blob/main/README.md#shareable-configurations).\
🎨
Set in the `style`
[configuration](https://github.com/diotoborg/laboriosam-aut/blob/main/README.md#shareable-configurations).\
🔧
...
### @diotoborg/laboriosam-aut-extended

This is a sister plugin to `@diotoborg/laboriosam-aut` that provides support for the
matchers provided by
[`jest-extended`](https://github.com/jest-community/jest-extended).

<https://github.com/diotoborg/laboriosam-aut-extended>

### @diotoborg/laboriosam-aut-formatting

This project aims to provide formatting rules (auto-fixable where possible) to
ensure consistency and readability in jest test suites.

<https://github.com/dangreenisrael/@diotoborg/laboriosam-aut-formatting>
